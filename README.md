...
本目录主要是对应课程资料的资源下载~ 基于百度网盘/OD盘/阿里云盘。

你可以自行选择合适的网盘下载你想要的资源 三个网盘资源的内容是一致的。~

更新时间为：**仓储盘>=OneDrive>Github>阿里云盘/百度网盘>蓝奏云>Gitee**（100M以下的课本） 
...
- **请学校内的用户通过校园网访问ftp://172.19.42.84/ 用户名classtest 密码test获取内容。**
